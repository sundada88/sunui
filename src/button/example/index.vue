<template>
  ...
  <sun-button type="primary" round>aa</sun-button>

  <app-type>注册事件</app-type>
  <sun-button type="success" @click="handleClick">点击</sun-button>
  <sun-button type="success" @touchstart="handleTouchstart">触摸</sun-button>
</template>
